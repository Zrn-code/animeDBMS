            ...
            <div className="modal-body mt-5">
                <div className="flex"> 
                    ...
                    <div className="ml-5 flex-1">
                        ...
                        <select className="select w-full max-w-xs select-bordered" value={Rating['state']} onChange={(e) => setRating({...Rating, state: e.target.value})}>
                ...
                <div className="modal-action">
                    ...
                    <button  className="btn btn-primary px-6" onClick={() => saveWatchList()}>Save</button>
                </div>
            </div>
        </>
    )
